...
namespace NativeDeviceControlLib
{
    ...
    /// </summary>
    public static class NativeDeviceMessageEvents
    {
        ...
        /// <summary>
        /// NativeDeviceMessageEvents delegate.
        /// </summary>
        ...
        /// <summary>
        /// Returns the NativeDeviceMessageEvents native Windows handle.
        /// </summary>
            ...
            lock (_lock)
            {
                if (_window == null)
                {
                    ...
                    using (ManualResetEvent mre = new ManualResetEvent(false))
                    {
                        ...
                        t.Name = "NativeDeviceMessageEvents message loop";
                        t.IsBackground = true;
                        t.Start();
        ...
        private class MessageWindow : Form
        {
            ...
            protected override void WndProc(ref Message m)
            {
                ...
                if (handleMessage)
                {
                    NativeDeviceMessageEvents._context.Post(delegate(object state)
                    {
                        EventHandler<MessageReceivedEventArgs> handler = NativeDeviceMessageEvents.MessageReceived;
